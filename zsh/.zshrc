...
alias c-cd="cd ~/Programming/Projects/custobar/custobar/webpack"
alias c-tail="tailscale up --accept-routes"
alias c-ip="sudo ip address add 10.1.1.20/32 dev lo:20 && sudo ip link set lo:20 up"
